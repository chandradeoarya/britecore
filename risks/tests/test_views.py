...
class GetAllRisksTest(TestCase):
    ...
    def setUp(self):
        ...
        Risk.objects.create(name='New Risk 2', description='New Risk 2 description')
...
class GetAllFieldsTest(TestCase):
    ...
    def setUp(self):
        risk = Risk.objects.create(name='New Risk 1', description='New Risk 1 description')
        risk2 = Risk.objects.create(name='New Risk 2', description='New Risk 2 description')
...
class GetSingleFieldTest(TestCase):
    ...
    def setUp(self):
        ...
        date1 = Date.objects.get(value='2017-10-29T16:29:08.175Z')
        enum1 = Enum.objects.get(value='age')
        self.field1 = Field.objects.create(name='Field 1', value=enum1, risk_id=8)
        self.field2 = Field.objects.create(name='Field 2', value=date1, risk_id=9)
...
class CreateNewRiskTest(TestCase):
    ...
    def setUp(self):
        self.valid_payload = {
            'name': 'New Risk 1',
            'description': 'New Risk 1 description'
        }
