...
class FieldTest(TestCase):
    ...
    def setUp(self):
        Risk.objects.create(name='Risk field 1', description='Risk field 1 description')
        Risk.objects.create(name='Risk field 2', description='Risk field 2 description')
        ...
        riskf1 = Risk.objects.get(name='Risk field 1')
        riskf2 = Risk.objects.get(name='Risk field 2')
